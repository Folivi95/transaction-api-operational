...
// 			DecodeFunc: func(ctx context.Context, buf []byte, schemaKey string) (interface{}, []byte, error) {
...
func (mock *SchemaRegistryMock) Decode(ctx context.Context, buf []byte, schemaKey string) (interface{}, []byte, error) {
	...
	return mock.DecodeFunc(ctx, buf, schemaKey)
}
